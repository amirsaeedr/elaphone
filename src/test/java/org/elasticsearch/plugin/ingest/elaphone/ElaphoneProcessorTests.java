...
public class ElaphoneProcessorTests extends ESTestCase {
    ...
    public void testThatProcessorWorks() throws Exception {
        ...
        ElaphoneProcessor processor = new ElaphoneProcessor(randomAlphaOfLength(10), "description", "source_field", "target_field");
